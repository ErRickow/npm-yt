...
module.exports = {
  extends: [js.configs.recommended], // Menggunakan extends agar lebih rapi
  languageOptions: {
    ecmaVersion: 'latest',
    sourceType: 'module',
    globals: {
  ...
  plugins: ['prettier', 'unused-imports'], // Memastikan plugins hanya dalam array
  rules: {
  ...
  fix: true // Memastikan auto-fix saat ESLint dijalankan
};