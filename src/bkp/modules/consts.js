...
const REGEX_VIDEO_LIKES = /<span class="icon thumb-up"><\/span><span class="value">(.*?)<\/span>/s;
const REGEX_VIDEO_DISLIKES = /<span class="icon thumb-down"><\/span><span class="value">(.*?)<\/span>/s;
const REGEX_VIDEO_COMMENT_COUNT = /<span class="icon comments"><\/span><span class="value">(.*?)<\/span>/;
...
const REGEX_MODEL_TOTAL_VIDEO_VIEWS = /<span class="icon-f icf-eye"><\/span> (.*?) video views/;